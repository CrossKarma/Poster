...
Write ten video generation prompts that fit this channel and lean on what is
trending. Each is one self-contained prompt the creator can paste straight into
an AI video tool: describe the scene, mood, camera and motion, under 30 words.

Respond with ONLY a JSON array of ten strings, no preamble, no markdown fences."""
...
{{
 ...
 "bestHours": [three integers 0 to 23, the starting hour of each window above in the creator's likely local time],
 "postsPerDay": one integer 1 to 5, how many videos per day this channel should realistically post given its niche and current performance,
